...
uint32_t vectors[] __attribute__((section (".isr_vector"))) = {
	...
	(uint32_t) ETH_IRQHandler, // 0x0000 0134
	(uint32_t) ETH_WKUP_IRQHandler, // 0x0000 0138
	...
	(uint32_t) CRYP_IRQHandler, // 0x0000 017C
	(uint32_t) HASH_RNG_IRQHandler, // 0x0000 0180
